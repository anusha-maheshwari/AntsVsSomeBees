    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                # BEGIN SOLUTION "Problem 9" ALT="assert self.ant is None, 'Two ants in {0}'.format(self)"
...
class Insect(object):
    ...
    # BEGIN SOLUTION "Problem 11" NO PROMPT
    is_watersafe = False
    # END SOLUTION
...
class Bee(Insect):
    ...
    def blocked(self):
        ...
        # BEGIN SOLUTION "Problem 7" ALT="return self.place.ant is not None"
        ant = self.place.ant
...
class Ant(Insect):
    ...
    food_cost = 0
    # ADD CLASS ATTRIBUTES HERE
    # BEGIN SOLUTION "Problem 7" NO PROMPT
    blocks_path = True
    # END SOLUTION
    # BEGIN SOLUTION "Problem 9" NO PROMPT
    is_container = False
    # END SOLUTION
...
class HarvesterAnt(Ant):
    ...
    implemented = True
    # OVERRIDE CLASS ATTRIBUTES HERE
    # BEGIN SOLUTION "Problem 1" NO PROMPT
    food_cost = 2
    # END SOLUTION
...
class ThrowerAnt(Ant):
    ...
    food_cost = 3
    # END SOLUTION
    # BEGIN SOLUTION "Problem 4" NO PROMPT
    min_range = 0
    max_range = float('inf')
    # END SOLUTION
    ...
    def nearest_bee(self, hive):
        ...
        """
        # BEGIN SOLUTION "Problem 3 and 4" ALT="return random_or_none(self.place.bees)"
        place = self.place
        dist = 0
...
class ShortThrower(ThrowerAnt):
    ...
    name = 'Short'
    # OVERRIDE CLASS ATTRIBUTES HERE
    # BEGIN SOLUTION "Problem 4" ALT="implemented = False   # Change to True to view in the GUI"
    implemented = True
    food_cost = 2
    max_range = 3
    # END SOLUTION
...
class FireAnt(Ant):
    ...
    damage = 3
    # OVERRIDE CLASS ATTRIBUTES HERE
    # BEGIN SOLUTION "Problem 5" ALT="implemented = False   # Change to True to view in the GUI"
    implemented = True
    food_cost = 5
    # END SOLUTION
...
class HungryAnt(Ant):
    ...
    name = 'Hungry'
    # OVERRIDE CLASS ATTRIBUTES HERE
    # BEGIN SOLUTION "Problem 6" ALT="implemented = False   # Change to True to view in the GUI"
    implemented = True
    food_cost = 4
    time_to_digest = 3
    # END SOLUTION
...
class NinjaAnt(Ant):
    ...
    damage = 1
    # OVERRIDE CLASS ATTRIBUTES HERE
    # BEGIN SOLUTION "Problem 7" ALT="implemented = False   # Change to True to view in the GUI"
    implemented = True
    blocks_path = False
    food_cost = 5
    # END SOLUTION
...
# BEGIN SOLUTION "Problem 8" ALT="# The WallAnt class"
class WallAnt(Ant):
    """WallAnt has a large amount of armor."""
...
class BodyguardAnt(Ant):
    ...
    name = 'Bodyguard'
    # OVERRIDE CLASS ATTRIBUTES HERE
    # BEGIN SOLUTION "Problem 9" ALT="implemented = False   # Change to True to view in the GUI"
    implemented = True
    food_cost = 4
    is_container = True
    # END SOLUTION
...
class TankAnt(BodyguardAnt):
    ...
    damage = 1
    # OVERRIDE CLASS ATTRIBUTES HERE
    # BEGIN SOLUTION "Problem 10" ALT="implemented = False   # Change to True to view in the GUI"
    implemented = True
    food_cost = 6
    # END SOLUTION
...
class Water(Place):
    ...
    def add_insect(self, insect):
        ...
        its armor to 0."""
        # BEGIN SOLUTION "Problem 11"
        Place.add_insect(self, insect)
        if not insect.is_watersafe:
            insect.reduce_armor(insect.armor)
        # END SOLUTION

# BEGIN SOLUTION "Problem 12" ALT="# The ScubaThrower class"
...
# BEGIN SOLUTION "Problem 13" ALT="class QueenAnt(Ant):  # You should change this line"
...
# END SOLUTION
    ...
    name = 'Queen'
    # OVERRIDE CLASS ATTRIBUTES HERE
    # BEGIN SOLUTION "Problem 13" ALT="implemented = False   # Change to True to view in the GUI"
    implemented = True
    food_cost = 7
    next_index = 0
    # END SOLUTION
    ...
    def double_damage(self, ant):
        ...
        if not ant:
            return
        if ant not in self.doubled and self is not ant:
            ant.damage = 2 * ant.damage
            self.doubled.append(ant)
        if ant.is_container:
            self.double_damage(ant.contained_ant)
        # END SOLUTION
...
def apply_effect(effect, bee, duration):
    ...
    effect_action = effect(original_action, bee)
    def action(colony):
        nonlocal duration
        if duration <= 0:
...
class SlowThrower(ThrowerAnt):
    ...
    name = 'Slow'
    # BEGIN SOLUTION "Problem EC" ALT="implemented = False   # Change to True to view in the GUI"
    implemented = True
    food_cost = 4
    # END SOLUTION
...
class ScaryThrower(ThrowerAnt):
    ...
    def throw_at(self, target):
        # BEGIN SOLUTION "Problem EC"
        if target and not target.was_scared:
            target.was_scared = True
...
class LaserAnt(ThrowerAnt):
    ...
    name = 'Laser'
    # OVERRIDE CLASS ATTRIBUTES HERE
    # BEGIN SOLUTION "Problem OPTIONAL" ALT="implemented = False   # Change to True to view in the GUI"
    implemented = True
    distance_weakening = 0.2
    insects_shot_weakening = 0.05
    food_cost = 10
    damage = 2
    # END SOLUTION
    ...
    def insects_in_front(self, hive):
        # BEGIN SOLUTION "Problem OPTIONAL" ALT="return {}"
        place = self.place
        distance = 0
        insects_and_distance = {}
        while place is not hive:
            insects = place.bees[:]
            if place.ant is not None and place.ant is not self:
                insects.append(place.ant)
            for insect in insects:
                insects_and_distance[insect] = distance
            place = place.entrance
            distance += 1
        return insects_and_distance
        # END SOLUTION

    def calculate_damage(self, distance):
        # BEGIN SOLUTION "Problem OPTIONAL" ALT="return 0"
        return max(0, self.damage - self.distance_weakening * distance - self.insects_shot_weakening * self.insects_shot)
        # END SOLUTION
...
class AntColony(object):
    ...
    def __init__(self, strategy, hive, ant_types, create_places, dimensions, food=30):
